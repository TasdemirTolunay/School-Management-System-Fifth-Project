...
public class GlobalExceptionHandler {
    ...
    @ExceptionHandler({ReductionNotValidException.class})
    @ResponseStatus(HttpStatus.FORBIDDEN)
    public ResponseEntity<ExceptionsAppErrorResponse> handleException(ReductionNotValidException exception){
